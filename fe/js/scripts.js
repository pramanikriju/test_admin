...
(function() {
	...
	*/
    ...
    $('.panel .panel-heading').click(function () {
      ...
      if ($(this).children(".tools").children(".t-collapse").hasClass("fa-chevron-down")) {
          $(this).children(".tools").children(".t-collapse").removeClass("fa-chevron-down").addClass("fa-chevron-up");
          el.slideUp(200);
      } else {
          $(this).children(".tools").children(".t-collapse").removeClass("fa-chevron-up").addClass("fa-chevron-down");
          el.slideDown(200); }
  });
